...
- 🎚️ **Conversation Mode Control**: Control AI proactivity with Quiet/Standard/Deep conversation modes
...
Level 2 · Standard Conversation Mode
→ AI occasionally asks light questions
→ Natural conversation flow

Level 3 · Deep Conversation Mode
...
python eval_auto_improved.py
# → Generates eval_auto_results_improved.csv
```
...
| Category       | TextRank | KoBART | Hybrid |
| -------------- | -------- | ------ | ------ |
